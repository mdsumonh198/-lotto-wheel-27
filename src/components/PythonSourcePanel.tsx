...
- Card 4: Thumb-Friendly CSV Download + Mobile Ticket Cards List
\"\"\"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-neutral-400 mt-1">
              Complete, self-contained Python code for <code className="text-emerald-400 font-mono">app.py</code> with Dynamic Game Configuration, Smart Budget Ranking, and CSV Export.
            </p>
          </div>
      ...
      <div className="bg-[#161b22] border border-neutral-800 rounded-xl overflow-hidden">
        <div className="p-3.5 bg-neutral-900 border-b border-neutral-800 flex items-center justify-between">
          <div className="flex items-center gap-2 text-xs font-mono font-semibold text-neutral-300">
            ...
            <span>app.py (Streamlit Web Application — Dynamic Games & Smart Budget)</span>
          </div>
          <div className="flex items-center gap-2">
            <button
