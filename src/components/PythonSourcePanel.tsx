...
# -----------------------------------------------------------------------------
# 1. Mobile-First Page Config & Global CSS Reset
# -----------------------------------------------------------------------------
st.set_page_config(
...
MOBILE_APP_CSS = \"\"\"
<style>
/* 1. ZERO HORIZONTAL SCROLLBARS GLOBALLY */
...
/* Force Fluid Containers without cutoff */
...
st.markdown(
    ...
    <div class="m-card">
        <div class="card-title-row">
            ...
            <span class="card-title">Choose Budget (Smart Stops)</span>
        </div>
    \"\"\",
    unsafe_allow_html=True
)
...
st.markdown(
    ...
    <div class="m-card">
        <div class="card-title-row">
            ...
            <span class="card-title">Select 6 Numbers (1 to 27)</span>
        </div>
    \"\"\",
    unsafe_allow_html=True
)
...
st.markdown(
    ...
    <div class="m-card">
        <div class="card-title-row">
            ...
            <span class="card-title">Instant Win Results</span>
        </div>
    \"\"\",
    unsafe_allow_html=True
)
...
st.markdown(
    ...
    <div class="m-card">
        <div class="card-title-row">
            ...
            <span class="card-title">Live Matching Tickets & Milestones</span>
        </div>
    \"\"\",
    unsafe_allow_html=True
)
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-base font-bold text-white flex items-center gap-2">
              ...
              <span>Production-Ready Streamlit Source Code</span>
            </h2>
            <p className="text-xs text-neutral-400 mt-1">
              Ultra-clean, 100% native mobile responsive Python code for <code className="text-emerald-400 font-mono">app.py</code> with 3-Step UX, Smart Budget Stops, and CSV Export.
            </p>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={() => handleDownload('app.py', APP_PY_CODE)}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-950 text-emerald-300 hover:bg-emerald-900 border border-emerald-800 rounded-lg text-xs font-semibold transition-colors"
            >
      ...
      <div className="bg-[#161b22] border border-neutral-800 rounded-xl overflow-hidden">
        <div className="p-3.5 bg-neutral-900 border-b border-neutral-800 flex items-center justify-between">
          <div className="flex items-center gap-2 text-xs font-mono font-semibold text-neutral-300">
            ...
            <span>app.py (Streamlit Mobile Native App — 6/27 Smart Stops)</span>
          </div>
          <div className="flex items-center gap-2">
            <button
